package com.os.stefanos.foodcube.tools;
...
//	}
    ...
    public static Bitmap getBitmapFromAssets(Context context, String fileName) {
        ...
        String completePath = "restaurantImages/" + fileName;
        InputStream istr = null;
        try {
            istr = assetManager.open(completePath);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static Bitmap getBitmapFromAssetsMeals(Context context, String fileName) {
        AssetManager assetManager = context.getAssets();
        String completePath = "mealImages/" + fileName;
        InputStream istr = null;
        try {
            istr = assetManager.open(completePath);
        } catch (IOException e) {
